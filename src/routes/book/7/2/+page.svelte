<main>
 <h2 id="method-syntax">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#method-syntax")
}}>
   Method Syntax
  </a>
 </h2>
 <p>
  ...
  are similar to functions: we declare them with the
  <code>
   fn
  </code>
  keyword and a
...
object, which we cover in
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch17-02-trait-objects.html")
}}>
   Chapter
17
  </a>
...
called on.
 ...
 <h3 id="defining-methods">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#defining-methods")
}}>
   Defining Methods
  </a>
 </h3>
...
type
  ...
  is an alias for the type that the
  <code>
   impl
  </code>
...
lets you abbreviate this with only the name
  <code>
   self
  </code>
...
Note that we still need to use the
  ...
  shorthand to
indicate that this method borrows the
  <code>
   Self
  </code>
  ...
  immutably, as we’ve done here, or borrow
  <code>
   self
  </code>
...
other parameter.
 ...
 <p>
  ...
  here for the same reason we used
  <code>
   &amp;Rectangle
  </code>
  in the function
...
called the method on as part of what the method does, we’d use
  <code>
   &amp;mut self
  </code>
  as
...
used when the method transforms
  <code>
   self
  </code>
...
with an instance of a type in one
  <code>
   impl
  </code>
  block rather than making future users
of our code search for capabilities of
  <code>
   Rectangle
  </code>
...
fields. For example, we can define a method on
  <code>
   Rectangle
  </code>
  that is also named
...
are and how to designate a field or method as public or private in
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch07-03-paths-for-referring-to-an-item-in-the-module-tree.html#exposing-paths-with-the-pub-keyword")
}}>
   Chapter
7
  </a>
 ...
 <section aria-role="note" class="note">
  <h3 id="wheres-the---operator">
   <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#wheres-the---operator")
}}>
    Where’s the
    <code>
     -&gt;
...
pointer first. In other words, if
   <code>
    object
   </code>
   is a pointer,
...
making ownership ergonomic in practice.
 ...
 <h3 id="methods-with-more-parameters">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#methods-with-more-parameters")
}}>
 ...
 <p>
  ...
  struct. This time we want an instance of
  <code>
   Rectangle
  </code>
...
within
  ...
  .
That is, once we’ve defined the
  <code>
   can_hold
  </code>
...
&#125;</code></pre>
 ...
 <p>
  ...
  are smaller than the dimensions of
  <code>
   rect1
  </code>
  , but
...
Boolean, and the implementation will check whether the width and height of
  ...
  are greater than the width and height of the other
  <code>
   Rectangle
  </code>
  ,
respectively. Let’s add the new
  <code>
   can_hold
  </code>
  method to the
...
<span class="boring">
 ...
 <p>
  When we run this code with the
  <code>
   main
  </code>
...
parameters in functions.
 ...
 <h3 id="associated-functions">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#associated-functions")
}}>
 ...
 <p>
  ...
  because they’re associated with the type named after the
  <code>
   impl
  </code>
  . We can define
...
We’ve already used one function like this: the
  <code>
   String::from
  </code>
  function that’s
...
will return a new instance of the struct. These are often called
  <code>
   new
  </code>
  , but
...
could choose to provide an associated function named
  <code>
   square
  </code>
  that would have
one dimension parameter and use that as both width and height, thus making it
easier to create a square
  <code>
   Rectangle
  </code>
...
aliases for the type that appears after the
  <code>
   impl
  </code>
...
namespaces created by modules. We’ll discuss modules in
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch07-02-defining-modules-to-control-scope-and-privacy.html")
}}>
   Chapter
7
  </a>
 ...
 <h3 id="multiple-impl-blocks">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#multiple-impl-blocks")
}}>
   Multiple
   <code>
    impl
...
<span class="boring">
 ...
 <p>
  ...
  blocks here,
but this is valid syntax. We’ll see a case in which multiple
  <code>
   impl
  </code>
  blocks are
...
and name each piece to make your code clear. In
  <code>
   impl
  </code>
