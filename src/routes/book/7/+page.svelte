<main>
 <h1 id="using-structs-to-structure-related-data">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#using-structs-to-structure-related-data")
}}>
 ...
 <p>
  ...
  , is a custom data type that lets you package
together and name multiple related values that make up a meaningful group. If
you’re familiar with an object-oriented language, a
  <em>
   struct
  </em>
  is like an
...
define associated functions, especially the kind of associated functions called
  ...
  , to specify behavior associated with a struct type. Structs and enums
