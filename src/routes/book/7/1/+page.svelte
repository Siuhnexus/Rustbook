<main>
 <h2 id="an-example-program-using-structs">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#an-example-program-using-structs")
}}>
...
of Chapter 3: by using tuples.
 ...
 <h3 id="refactoring-with-tuples">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#refactoring-with-tuples")
}}>
...
our data in our code, it’s now easier to introduce errors.
 ...
 <h3 id="refactoring-with-structs-adding-more-meaning">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#refactoring-with-structs-adding-more-meaning")
}}>
...
&#125;</code></pre></pre>
 ...
 <p>
  Here we’ve defined a struct and named it
  <code>
   Rectangle
  </code>
  . Inside the curly
brackets, we defined the fields as
  <code>
   width
  </code>
  and
...
type
  ...
  , we created a particular instance of
  <code>
   Rectangle
  </code>
  that has a width of
 ...
 <p>
  ...
  , whose type is an immutable borrow of a struct
  <code>
   Rectangle
  </code>
  instance. As mentioned in Chapter 4, we want to borrow the struct rather than
take ownership of it. This way,
  <code>
   main
  </code>
...
the values rather than using the tuple index values of
  <code>
   0
  </code>
  and
...
win for clarity.
 ...
 <h3 id="adding-useful-functionality-with-derived-traits">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#adding-useful-functionality-with-derived-traits")
}}>
...
using the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/macro.println.html")
}}>
   <code>
    println!
   </code>
...
&#125;</code></pre>
  <figcaption>
   Listing 5-11: Attempting to print a
   <code>
    Rectangle
   </code>
   instance
...
implementation of
 ...
 <p>
  ...
  we want to use an output format called
  <code>
   Debug
  </code>
  . The
...
see its value while we’re debugging our code.
 ...
 <p>
  ...
  include functionality to print out debugging information, but we
have to explicitly opt in to make that functionality available for our struct.
To do that, we add the outer attribute
  <code>
   #[derive(Debug)]
  </code>
  just before the
...
&#125;
 ...
 <p>
  ...
  format is to use the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/macro.dbg.html")
}}>
   <code>
    dbg!
   </code>
...
console stream (
   ...
   <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch12-06-writing-to-stderr-instead-of-stdout.html")
}}>
...
section in Chapter 12
 ...
 <p>
  ...
  field, as well as the value of the whole struct in
  <code>
   rect1
  </code>
  :
...
&#125;</code></pre></pre>
 <p>
  ...
  returns ownership of the expression’s value, the
  <code>
   width
  </code>
  field will get the
same value as if we didn’t have the
  <code>
   dbg!
  </code>
  call there. We don’t want
  <code>
   dbg!
  </code>
  to
...
&#125;
 ...
 <p>
  We can see the first bit of output came from
  <em>
   src/main.rs
  </em>
  line 10 where we’re
...
the
  ...
  struct. This output uses the pretty
  <code>
   Debug
  </code>
  formatting of the
...
types. Those traits and their behaviors are listed in
  <a href="#" onclick={() => {
    // @ts-ignore
...
attributes other than
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../reference/attributes.html")
}}>
   the “Attributes”
...
refactor this code by turning the
  <code>
   area
  </code>
  function into an
