<main>
 <h2 id="reading-a-file">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#reading-a-file")
}}>
   Reading a File
  </a>
 </h2>
...
has an Emily Dickinson poem that will work well! Create a file called
  ...
  at the root level of your project, and enter the poem “I’m Nobody!
Who are you?”
 </p>
...
To an admiring bog!
 ...
 <p>
  With the text in place, edit
  <em>
   src/main.rs
  </em>
  and add code to read the file, as
...
&#125;</code></pre>
 ...
 <p>
  ...
  , opens
that file, and returns a value of type
  <code>
...
the file’s contents.
 ...
 <p>
  After that, we again add a temporary
  <code>
   println!
  </code>
...
we haven’t implemented the searching part yet) and the
  <em>
   poem.txt
  </em>
  file as the
...
has a few flaws. At the moment, the
  <code>
   main
  </code>
