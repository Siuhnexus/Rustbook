<main>
 <h2 id="data-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#data-types")
}}>
   Data Types
  </a>
 </h2>
...
error: could not compile `no_type_annotations` (bin "no_type_annotations") due to 1 previous error
 ...
 <h3 id="scalar-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#scalar-types")
}}>
   Scalar Types
  </a>
 </h3>
...
these from other programming languages. Let’s jump into how they work in Rust.
 ...
 <h4 id="integer-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#integer-types")
}}>
   Integer Types
  </a>
 </h4>
...
Signed numbers are stored using
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://en.wikipedia.org/wiki/Two%27s_complement")
}}>
   two’s complement
  </a>
  <!-- ignore
...
1
  ...
  - 1, which equals
-128 to 127. Unsigned variants can store numbers from 0 to 2
  <sup>
   n
  </sup>
  - 1,
...
some sort of collection.
 ...
 <section aria-role="note" class="note">
  <h5 id="integer-overflow">
   <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#integer-overflow")
}}>
    Integer Overflow
   </a>
  </h5>
...
uses the term
   ...
   when a program exits with an error; we’ll discuss
panics in more depth in the
   <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch09-01-unrecoverable-errors-with-panic.html")
}}>
...
the
 ...
 <h4 id="floating-point-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#floating-point-types")
}}>
 ...
 <p>
  ...
  , which are
numbers with decimal points. Rust’s floating-point types are
  <code>
   f32
  </code>
  and
...
&#125;</code></pre></pre>
 <p>
  ...
  type is a single-precision float, and
  <code>
   f64
  </code>
 ...
 <h4 id="numeric-operations">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#numeric-operations")
}}>
   Numeric Operations
  </a>
 </h4>
...
how you’d use each numeric operation in a
  <code>
   let
  </code>
  statement:
...
to a single value, which is then bound to a variable.
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("appendix-02-operators.html")
}}>
   Appendix
B
  </a>
...
provides.
 ...
 <h4 id="the-boolean-type">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#the-boolean-type")
}}>
   The Boolean Type
  </a>
 </h4>
...
&#125;</code></pre></pre>
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch03-05-control-flow.html#control-flow")
}}>
   “Control
Flow”
  </a>
 ...
 <h4 id="the-character-type">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#the-character-type")
}}>
   The Character Type
  </a>
 </h4>
...
literals, which use double quotes. Rust’s
  <code>
   char
  </code>
...
and zero-width spaces are all valid
  <code>
   char
  </code>
...
intuition for what a “character” is may not match up with what a
  <code>
   char
  </code>
  is in
...
Strings”
 ...
 <h3 id="compound-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#compound-types")
}}>
   Compound Types
  </a>
 </h3>
...
primitive compound types: tuples and arrays.
 ...
 <h4 id="the-tuple-type">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#the-tuple-type")
}}>
   The Tuple Type
  </a>
 </h4>
...
return any other value.
 ...
 <h4 id="the-array-type">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#the-array-type")
}}>
   The Array Type
  </a>
 </h4>
...
stack and the heap more in
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch04-01-what-is-ownership.html#the-stack-and-the-heap")
}}>
   Chapter 4
  </a>
  <!-- ignore -->
...
flexible as the vector type, though. A
  <em>
   vector
  </em>
  is a similar collection type
provided by the standard library that
  <em>
   is
  </em>
  allowed to grow or shrink in size. If
you’re unsure whether to use an array or a vector, chances are you should use a
vector.
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch08-01-vectors.html")
}}>
   Chapter 8
  </a>
  <!-- ignore -->
...
more concise way.
 ...
 <h5 id="accessing-array-elements">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#accessing-array-elements")
}}>
...
the value
 ...
 <h5 id="invalid-array-element-access">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#invalid-array-element-access")
}}>
...
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
 ...
 <p>
  ...
  error at the point of using an invalid
value in the indexing operation. The program exited with an error message and
didn’t execute the final
  <code>
   println!
  </code>
