...
important functions in the language: the
  <code>
   main
  </code>
  function, which is the entry
point of many programs. You’ve also seen the
  <code>
   fn
  </code>
...
declare new functions.
 ...
 <p>
  ...
  as the conventional style for function and variable
...
defined somewhere in a scope that can be seen by the caller.
 ...
 <p>
  Let’s start a new binary project named
  <em>
   functions
  </em>
...
Another function.
 ...
 <p>
  ...
  function.
First the “Hello, world!” message prints, and then
  <code>
   another_function
  </code>
  is called
and its message is printed.
 ...
 <h3 id="parameters">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#parameters")
}}>
   Parameters
  </a>
 </h3>
 <p>
  We can define functions to have
  <em>
   parameters
  </em>
...
values are called
  ...
  , but in casual conversation, people tend to use
the words
  <em>
   parameter
  </em>
  ...
  interchangeably for either the variables
...
The value of x is: 5
 ...
 <p>
  ...
  where the pair of curly brackets containing
  <code>
   x
  </code>
  was
in the format string.
 ...
 <p>
  In function signatures, you
  <em>
   must
  </em>
  declare the type of each parameter. This is
...
&#125;</code></pre></pre>
 <p>
  ...
  with two
parameters. The first parameter is named
  <code>
   value
  </code>
  and is an
...
both the
 ...
 <p>
  ...
  file with the preceding example and run it using
  <code>
   cargo run
  </code>
  :
...
The measurement is: 5h
 ...
 <p>
  Because we called the function with
  <code>
   5
  </code>
  as the value for
...
the value for
 ...
 <h3 id="statements-and-expressions">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#statements-and-expressions")
}}>
...
of functions.
 ...
 <ul>
  <li>
   ...
   are instructions that perform some action and do not return
a value.
  </li>
  <li>
   <strong>
   ...
   evaluate to a resultant value. Let’s look at some examples.
  </li>
 </ul>
 <p>
  We’ve actually already used statements and expressions. Creating a variable and
assigning a value to it with the
  <code>
   let
  </code>
...
statement in itself. (As we will see below,
  <em>
   calling
  </em>
  a function is not a
...
you’ll write in Rust. Consider a math operation, such as
  <code>
   5 + 6
  </code>
  , which is an
...
&#125;</code></pre>
 <p>
  is a block that, in this case, evaluates to
  <code>
   4
  </code>
  . That value gets bound to
  <code>
   y
  </code>
  as part of the
...
next.
 ...
 <h3 id="functions-with-return-values">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#functions-with-return-values")
}}>
...
&#125;</code></pre></pre>
 <p>
  There are no function calls, macros, or even
  <code>
   let
  </code>
  statements in the
...
return value, but the body of the function is a lonely
  <code>
   5
  </code>
  with no semicolon
...
&#125;</code></pre></pre>
 <p>
  ...
  . But if we place a
semicolon at the end of the line containing
  <code>
   x + 1
  </code>
  , changing it from an
...
code. The definition of the function
  <code>
   plus_one
  </code>
