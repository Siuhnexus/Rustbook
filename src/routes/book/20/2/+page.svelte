<main>
 <h2 id="pattern-syntax">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#pattern-syntax")
}}>
   Pattern Syntax
  </a>
 </h2>
...
when you might want to use each one.
 ...
 <h3 id="matching-literals">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#matching-literals")
}}>
   Matching Literals
  </a>
 </h3>
...
value.
 ...
 <h3 id="matching-named-variables">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#matching-named-variables")
}}>
...
named variables in
  ...
  starts a new scope,
variables declared as part of a pattern inside the
  <code>
   match
  </code>
  expression will
shadow those with the same name outside the
  <code>
   match
  </code>
  construct, as is the case
with all variables. In Listing 18-11, we declare a variable named
  <code>
   x
  </code>
  with the
...
introduces a shadowed variable
   <code>
    y
   </code>
  </span>
...
the
  ...
  we declared at
the beginning with the value 10. This new
  <code>
   y
  </code>
...
guard conditional instead. We’ll talk about match guards later in the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#extra-conditionals-with-match-guards")
}}>
   “Extra
...
ignore -->
 ...
 <h3 id="multiple-patterns">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#multiple-patterns")
}}>
   Multiple Patterns
  </a>
 </h3>
...
which is the pattern
  ...
  operator. For example, in the following code we match
the value of
  <code>
   x
  </code>
  against the match arms, the first of which has an
  <em>
   or
  </em>
  option,
meaning if the value of
  <code>
   x
  </code>
...
<span class="boring">&#125;</span></code></pre></pre>
 ...
 <h3 id="matching-ranges-of-values-with-">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#matching-ranges-of-values-with-")
}}>
...
<span class="boring">&#125;</span></code></pre></pre>
 ...
 <h3 id="destructuring-to-break-apart-values">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#destructuring-to-break-apart-values")
}}>
...
different parts of these values. Let’s walk through each value.
 ...
 <h4 id="destructuring-structs">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#destructuring-structs")
}}>
   Destructuring Structs
  </a>
 </h4>
 <p>
  Listing 18-12 shows a
  <code>
   Point
  </code>
...
way as the code in Listing 18-12, but the variables created in the
  <code>
   let
  </code>
  pattern are
...
matches any other
 ...
 <p>
  ...
  containing a 0, so this code will print
  <code>
   On the y axis at 7
  </code>
  .
...
and the
 ...
 <h4 id="destructuring-enums">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#destructuring-enums")
}}>
   Destructuring Enums
  </a>
 </h4>
...
example, in Listing 18-15 we use the
  <code>
   Message
  </code>
...
matching.
 ...
 <h4 id="destructuring-nested-structs-and-enums">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#destructuring-nested-structs-and-enums")
}}>
...
code in Listing 18-15 to support RGB and HSV colors in the
  <code>
   ChangeColor
  </code>
...
matches
 ...
 <h4 id="destructuring-structs-and-tuples">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#destructuring-structs-and-tuples")
}}>
...
as the value from each field in a struct, separately from each other.
 ...
 <h3 id="ignoring-values-in-a-pattern">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#ignoring-values-in-a-pattern")
}}>
...
parts of a value. Let’s explore how and why to use each of these patterns.
 ...
 <h4 id="ignoring-an-entire-value-with-_">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#ignoring-an-entire-value-with-_")
}}>
...
would if you used a name instead.
 ...
 <h4 id="ignoring-parts-of-a-value-with-a-nested-_">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#ignoring-parts-of-a-value-with-a-nested-_")
}}>
...
ignored.
 ...
 <h4 id="ignoring-an-unused-variable-by-starting-its-name-with-_">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#ignoring-an-unused-variable-by-starting-its-name-with-_")
}}>
...
value
 ...
 <h4 id="ignoring-remaining-parts-of-a-value-with-">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#ignoring-remaining-parts-of-a-value-with-")
}}>
...
compiler error because using
 ...
 <h3 id="extra-conditionals-with-match-guards">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#extra-conditionals-with-match-guards")
}}>
