<main>
 <h2 id="all-the-places-patterns-can-be-used">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#all-the-places-patterns-can-be-used")
}}>
...
valid.
 ...
 <h3 id="match-arms">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#match-arms")
}}>
   <code>
    match
   </code>
...
cover the
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch18-03-pattern-syntax.html#ignoring-values-in-a-pattern")
}}>
...
chapter.
 ...
 <h3 id="conditional-if-let-expressions">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#conditional-if-let-expressions")
}}>
   Conditional
   <code>
    if let
...
not alert us to the possible logic bug.
 ...
 <h3 id="while-let-conditional-loops">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#while-let-conditional-loops")
}}>
   <code>
    while let
   </code>
...
for as long as
 ...
 <p>
  This example prints 3, 2, and then 1. The
  <code>
   pop
  </code>
  method takes the last element
out of the vector and returns
  <code>
   Some(value)
  </code>
...
<span class="boring">&#125;</span></code></pre></pre>
 <p>
  <span class="caption">
   Listing 18-3: Using a pattern in a
   <code>
    for
   </code>
   loop to
...
output.
 ...
 <h3 id="let-statements">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#let-statements")
}}>
   <code>
    let
   </code>
...
18-4, which uses a pattern with
  <code>
   let
  </code>
...
of elements in the tuple.
 ...
 <h3 id="function-parameters">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#function-parameters")
}}>
   Function Parameters
  </a>
 </h3>
