<main>
 <h2 id="customizing-builds-with-release-profiles">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#customizing-builds-with-release-profiles")
}}>
 ...
 <p>
  ...
  are predefined and customizable profiles with
...
explicitly added any
  <code>
   [profile.*]
  </code>
  sections in the project’s
  <em>
   Cargo.toml
  </em>
  file.
...
why the default
 ...
 <p>
  ...
  . For example, if we want to use optimization level 1 in the
...
opt-level = 1
 ...
 <p>
  ...
  ,
Cargo will use the defaults for the
  <code>
   dev
  </code>
...
optimizations than the default, but not as many as in a release build.
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://doc.rust-lang.org/cargo/reference/profiles.html")
}}>
