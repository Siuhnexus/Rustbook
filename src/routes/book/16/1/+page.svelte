<main>
 <h2 id="publishing-a-crate-to-cratesio">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#publishing-a-crate-to-cratesio")
}}>
...
how to publish a package.
 ...
 <h3 id="making-useful-documentation-comments">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#making-useful-documentation-comments")
}}>
...
a particular kind of comment for documentation, known conveniently as a
  ...
  , that will generate HTML documentation. The HTML
displays the contents of documentation comments for public API items intended
for programmers interested in knowing how to
  <em>
   use
  </em>
...
&#125;</code></pre>
 ...
 <p>
  Here, we give a description of what the
  <code>
   add_one
  </code>
...
this documentation comment by running
  <code>
   cargo doc
  </code>
...
rendered, as shown in Figure 14-1:
 ...
 <img alt="Rendered HTML documentation for the `add_one` function of `my_crate`" class="center" src="/img/trpl14-01.png"/>
 <p>
  <span class="caption">
 ...
 <h4 id="commonly-used-sections">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#commonly-used-sections")
}}>
...
authors commonly use in their documentation:
 ...
 <ul>
  <li>
   ...
   : The scenarios in which the function being documented could
...
different kinds of errors in different ways.
  ...
  <li>
   ...
   to call (we discuss unsafety in
...
interested in knowing about.
 ...
 <h4 id="documentation-comments-as-tests">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#documentation-comments-as-tests")
}}>
...
that the example and the code are out of sync with each other!
 ...
 <h4 id="commenting-contained-items">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#commenting-contained-items")
}}>
...
these doc comments inside the crate root file (
  <em>
   src/lib.rs
  </em>
  by convention) or
...
<span class="boring">///
  ...
  <figcaption>
   Listing 14-2: Documentation for the
   <code>
    my_crate
   </code>
   crate as a whole
...
this case, that item is the
  <em>
   src/lib.rs
  </em>
  file, which is the crate root. These
...
crate, as shown in Figure 14-2:
 ...
 <img alt="Rendered HTML documentation with a comment for the crate as a whole" class="center" src="/img/trpl14-02.png"/>
 <p>
  <span class="caption">
   Figure 14-2: Rendered documentation for
   <code>
    my_crate
   </code>
   ,
...
help your users understand the crate’s organization.
 ...
 <h3 id="exporting-a-convenient-public-api-with-pub-use">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#exporting-a-convenient-public-api-with-pub-use")
}}>
...
has a large module hierarchy.
 ...
 <p>
  ...
  keyword, and
bring items into a scope with the
  <code>
   use
  </code>
...
They might also be annoyed at having to enter
  <code>
   use
  </code>
  <code>
 ...
 <p>
  The good news is that if the structure
  <em>
   isn’t
  </em>
...
from your private structure by using
  <code>
   pub use
  </code>
...
Within this library are two modules: a
  <code>
   kinds
  </code>
...
generated by
 ...
 <img alt="Rendered documentation for the `art` crate that lists the `kinds` and `utils` modules" class="center" src="/img/trpl14-03.png"/>
 <p>
  <span class="caption">
...
front page, nor is the
  <code>
   mix
  </code>
  function. We have to click
  <code>
   kinds
  </code>
  and
...
&#125;</code></pre>
  <figcaption>
   Listing 14-4: A crate using the
   <code>
    art
   </code>
   crate’s items with its internal structure exported
  </figcaption>
 </figure>
 <p>
...
figure out that
  ...
  module. The module structure of the
  <code>
   art
  </code>
...
module names in the
 ...
 <p>
  ...
  crate code in Listing 14-3 to add
  <code>
   pub use
  </code>
...
and link re-exports on the front page, as shown in Figure 14-4, making the
 ...
 <img alt="Rendered documentation for the `art` crate with the re-exports on the front page" class="center" src="/img/trpl14-04.png"/>
 <p>
  <span class="caption">
...
people who use the crate. Another common use of
  <code>
   pub use
  </code>
  is to re-export
...
differs from their public API.
 ...
 <h3 id="setting-up-a-cratesio-account">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#setting-up-a-cratesio-account")
}}>
...
you’re logged in, visit your account settings at
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://crates.io/me/")
}}>
   https://crates.io/me/
  </a>
  <!-- ignore -->
  and retrieve your
API key. Then run the
  <code>
   cargo login
  </code>
...
abcdefghijklmnopqrstuvwxyz012345
 ...
 <p>
  ...
  . Note that this token is a
  <em>
   secret
  </em>
  : do not share it
with anyone else. If you do share it with anyone for any reason, you should
revoke it and generate a new token on
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://crates.io/")
}}>
...
-->
 ...
 <h3 id="adding-metadata-to-a-new-crate">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#adding-metadata-to-a-new-crate")
}}>
...
terms they can use it. In
  <em>
   Cargo.toml
  </em>
  , add a description that’s just a
...
same way as Rust by using a dual license of
  <code>
   MIT OR Apache-2.0
  </code>
  . This practice
...
by
 ...
 <p>
  ...
  file for a project that is ready to publish might look like this:
 </p>
 <p>
  <span class="filename">
   Filename: Cargo.toml
...
easily.
 ...
 <h3 id="publishing-to-cratesio">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#publishing-to-cratesio")
}}>
...
Publishing a crate uploads a specific version to
 ...
 <p>
  Be careful, because a publish is
  <em>
   permanent
  </em>
  . The version can never be
...
anyone can easily add your crate as a dependency of their project.
 ...
 <h3 id="publishing-a-new-version-of-an-existing-crate">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#publishing-a-new-version-of-an-existing-crate")
}}>
...
Then run
 ...
 <p>
  <a id="removing-versions-from-cratesio-with-cargo-yank">
  </a>
 </p>
 <h3 id="deprecating-versions-from-cratesio-with-cargo-yank">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#deprecating-versions-from-cratesio-with-cargo-yank")
}}>
   Deprecating Versions from Crates.io with
   <code>
    cargo yank
   </code>
  </a>
...
yank means that all projects with a
  <em>
   Cargo.lock
  </em>
  will not break, and any future
  <em>
   Cargo.lock
  </em>
...
previously published, run
  <code>
   cargo yank
  </code>
  and specify which version you want to
yank. For example, if we’ve published a crate named
  <code>
   guessing_game
  </code>
  version
1.0.1 and we want to yank it, in the project directory for
  <code>
   guessing_game
  </code>
  we’d
...
to start depending on a version again:
 ...
 <p>
  ...
  delete any code. It cannot, for example, delete accidentally
