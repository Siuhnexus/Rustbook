<main>
 <h2 id="unsafe-rust">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#unsafe-rust")
}}>
   Unsafe Rust
  </a>
 </h2>
...
Rust and how to do it.
 ...
 <h3 id="unsafe-superpowers">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#unsafe-superpowers")
}}>
   Unsafe Superpowers
  </a>
 </h3>
...
some abstractions that provide a safe interface to unsafe code.
 ...
 <h3 id="dereferencing-a-raw-pointer">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#dereferencing-a-raw-pointer")
}}>
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch04-02-references-and-borrowing.html#dangling-references")
}}>
   “Dangling References”
  </a>
  <!-- ignore
...
valid. Unsafe Rust has two new types called
  <em>
   raw pointers
  </em>
  that are similar to
...
pointers,
  ...
  means that the pointer can’t be directly assigned to
...
unsafe block, as you’ll see in a bit.
 ...
 <p>
  We’ve created raw pointers by using
  <code>
   as
  </code>
...
case is when interfacing with C code, as you’ll see in the next section,
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#calling-an-unsafe-function-or-method")
}}>
...
unsafe operations within an unsafe function, we don’t need to add another
 ...
 <h4 id="creating-a-safe-abstraction-over-unsafe-code">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#creating-a-safe-abstraction-over-unsafe-code")
}}>
...
know code is okay, but Rust doesn’t, it’s time to reach for unsafe code.
 ...
 <p>
  Listing 19-6 shows how to use an
  <code>
   unsafe
  </code>
...
the
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch04-03-slices.html#the-slice-type")
}}>
   “The Slice Type”
  </a>
  <!-- ignore -->
...
mutable slice to
  ...
  , which we’ve stored in the variable
  <code>
   ptr
  </code>
  .
...
that the slice this code creates contains valid
 ...
 <h4 id="using-extern-functions-to-call-external-code">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#using-extern-functions-to-call-external-code")
}}>
   Using
   <code>
    extern
...
functions from another language we want to call. The
  <code>
   "C"
  </code>
  part defines which
...
most common and follows the C programming language’s ABI.
 ...
 <section aria-role="note" class="note">
  <h4 id="calling-rust-functions-from-other-languages">
   <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#calling-rust-functions-from-other-languages")
}}>
...
to call Rust functions. Instead of creating a whole
   <code>
    extern
   </code>
   block, we add
...
<span class="boring">&#125;</span></code></pre></pre>
 ...
 <h3 id="accessing-or-modifying-a-mutable-static-variable">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#accessing-or-modifying-a-mutable-static-variable")
}}>
   Accessing or Modifying a Mutable Static Variable
  </a>
 </h3>
 <p>
  In this book, we’ve not yet talked about
  <em>
   global variables
  </em>
  , which Rust does
...
accessing the same mutable global variable, it can cause a data race.
 ...
 <p>
  ...
  variables. Listing 19-9 shows an
...
variable
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch03-01-variables-and-mutability.html#constants")
}}>
...
variables can be mutable. Accessing and modifying mutable static variables is
  ...
  . Listing 19-10 shows how to declare, access, and modify a mutable
...
that data accessed from different threads is done safely.
 ...
 <h3 id="implementing-an-unsafe-trait">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#implementing-an-unsafe-trait")
}}>
...
the compiler can’t verify.
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch16-04-extensible-concurrency-sync-and-send.html#extensible-concurrency-with-the-sync-and-send-traits")
}}>
...
our types are composed entirely of
  <code>
   Send
  </code>
  and
...
type that contains a type that is not
  <code>
   Send
  </code>
  or
...
and we want to mark that type as
  <code>
   Send
  </code>
  or
...
those checks manually and indicate as such with
  <code>
   unsafe
  </code>
  .
 ...
 <h3 id="accessing-fields-of-a-union">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#accessing-fields-of-a-union")
}}>
...
instance. You can learn more about unions in
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../reference/items/unions.html")
}}>
   the Rust Reference
  </a>
  .
 ...
 <h3 id="when-to-use-unsafe-code">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#when-to-use-unsafe-code")
}}>
