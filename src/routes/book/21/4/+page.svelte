...
need macros when we already have functions.
 ...
 <h3 id="the-difference-between-macros-and-functions">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#the-difference-between-macros-and-functions")
}}>
...
opposed to functions you can define anywhere and call anywhere.
 ...
 <h3 id="declarative-macros-with-macro_rules-for-general-metaprogramming">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#declarative-macros-with-macro_rules-for-general-metaprogramming")
}}>
...
&#125;</code></pre>
 <p>
  <span class="caption">
   Listing 19-28: A simplified version of the
   <code>
    vec!
   </code>
   macro
...
Listing 19-28 mean; for the full macro pattern syntax, see the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../reference/macros-by-example.html")
}}>
   Rust
Reference
  </a>
...
other resources, such as
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://veykril.github.io/tlborm/")
}}>
...
Daniel Keep and continued by Lukas Wirth.
 ...
 <h3 id="procedural-macros-for-generating-code-from-attributes">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#procedural-macros-for-generating-code-from-attributes")
}}>
   Procedural Macros for Generating Code from Attributes
  </a>
 </h3>
 <p>
  The second form of macros is the
  <em>
   procedural macro
  </em>
  , which acts more like a
...
other forms different.
 ...
 <h3 id="how-to-write-a-custom-derive-macro">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#how-to-write-a-custom-derive-macro")
}}>
...
depending on your procedural macro’s purpose.
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://crates.io/crates/syn")
}}>
   <code>
    syn
   </code>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://crates.io/crates/quote")
}}>
   <code>
    quote
   </code>
...
with the
  ...
  (identifier, meaning the name) of
  <code>
   Pancakes
  </code>
  . There are more
fields on this struct for describing all sorts of Rust code; check the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://docs.rs/syn/2.0/syn/struct.DeriveInput.html")
}}>
   <code>
    syn
   </code>
...
for our derive macro is also a
  <code>
   TokenStream
  </code>
  . The returned
...
&#125;</code></pre>
 <p>
  <span class="caption">
   Listing 19-33: Implementing the
   <code>
    HelloMacro
   </code>
   trait using
...
the
  ...
  variable in Listing 19-33 will contain an
  <code>
   Ident
  </code>
  struct instance
...
Check out
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://docs.rs/quote")
}}>
   the
   <code>
    quote
...
hello_macro_derive = &#123; path = "../hello_macro/hello_macro_derive" &#125;
 ...
 <p>
  Put the code in Listing 19-30 into
  <em>
   src/main.rs
  </em>
  , and run
...
derive macros.
 ...
 <h3 id="attribute-like-macros">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#attribute-like-macros")
}}>
...
function that generates the code you want!
 ...
 <h3 id="function-like-macros">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#function-like-macros")
}}>
...
Metaprogramming”
  ...
  <!-- ignore -->
  earlier. Function-like macros take a
  <code>
   TokenStream
  </code>
  parameter and their definition manipulates that
  <code>
   TokenStream
  </code>
  using Rust code as the other two types of procedural macros do. An example of a
function-like macro is an
  <code>
   sql!
  </code>
