<main>
 <h1 id="introduction">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#introduction")
}}>
   Introduction
  </a>
 </h1>
 <section aria-role="note" class="note">
  <p>
   ...
   <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://nostarch.com/rust-programming-language-2nd-edition")
}}>
    The Rust Programming
Language
   </a>
   available in print and ebook format from
   <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://nostarch.com/")
}}>
    No Starch
Press
   </a>
...
traditionally associated with such control.
 ...
 <h2 id="who-rust-is-for">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#who-rust-is-for")
}}>
   Who Rust Is For
  </a>
 </h2>
...
the most important groups.
 ...
 <h3 id="teams-of-developers">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#teams-of-developers")
}}>
   Teams of Developers
  </a>
 </h3>
...
learning, and even major parts of the Firefox web browser.
 ...
 <h3 id="open-source-developers">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#open-source-developers")
}}>
...
language.
 ...
 <h3 id="people-who-value-speed-and-stability">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#people-who-value-speed-and-stability")
}}>
...
Rust a try and see if its choices work for you.
 ...
 <h2 id="who-this-book-is-for">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#who-this-book-is-for")
}}>
...
don’t spend a lot of time talking about what programming
  <em>
   is
  </em>
  or how to think
...
reading a book that specifically provides an introduction to programming.
 ...
 <h2 id="how-to-use-this-book">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#how-to-use-this-book")
}}>
 ...
 <div class="table-wrapper">
  <table>
   ...
   <tbody>
    <tr>
     <td>
      <img alt="Ferris with a question mark" class="ferris-explain" src="/img/ferris/does_not_compile.svg"/>
     </td>
     <td>
    ...
    <tr>
     <td>
      <img alt="Ferris throwing up their hands" class="ferris-explain" src="/img/ferris/panics.svg"/>
     </td>
     <td>
      This code panics!
     </td>
    ...
    <tr>
     <td>
      <img alt="Ferris with one claw up, shrugging" class="ferris-explain" src="/img/ferris/not_desired_behavior.svg"/>
     </td>
     <td>
...
doesn’t compile.
 ...
 <h2 id="source-code">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#source-code")
}}>
   Source Code
  </a>
 </h2>
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://github.com/rust-lang/book/tree/main/src")
}}>
   GitHub
  </a>
  .
