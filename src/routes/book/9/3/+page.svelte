<main>
 <h2 id="bringing-paths-into-scope-with-the-use-keyword">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#bringing-paths-into-scope-with-the-use-keyword")
}}>
...
&#125;</code></pre>
 <p>
  <span class="caption">
   ...
   statement only applies in the scope
it’s in
  </span>
 </p>
 <p>
...
the shortcut in the parent module with
 ...
 <h3 id="creating-idiomatic-use-paths">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#creating-idiomatic-use-paths")
}}>
   Creating Idiomatic
   <code>
    use
...
meant when we used
 ...
 <h3 id="providing-new-names-with-the-as-keyword">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#providing-new-names-with-the-as-keyword")
}}>
...
considered idiomatic, so the choice is up to you!
 ...
 <h3 id="re-exporting-names-with-pub-use">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#re-exporting-names-with-pub-use")
}}>
...
that name as if it had been defined in that code’s scope, we can combine
  <code>
   pub
  </code>
  and
...
of
  ...
  and how it affects your crate’s documentation in the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch14-02-publishing-to-crates-io.html#exporting-a-convenient-public-api-with-pub-use")
}}>
   “Exporting a
Convenient Public API with
   <code>
    pub use
   </code>
   ”
...
Chapter 14.
 ...
 <h3 id="using-external-packages">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#using-external-packages")
}}>
...
we wanted to bring into scope. Recall that in the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch02-00-guessing-game-tutorial.html#generating-a-random-number")
}}>
   “Generating a Random
Number”
  </a>
  <!-- ignore -->
  section in Chapter 2, we brought the
  <code>
   Rng
  </code>
  trait
into scope and called the
  <code>
   rand::thread_rng
  </code>
  function:
...
crate.
 ...
 <h3 id="using-nested-paths-to-clean-up-large-use-lists">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#using-nested-paths-to-clean-up-large-use-lists")
}}>
...
use std::io::Write;</code></pre>
 <p>
  <span class="caption">
   ...
   statements where one is a subpath
of the other
  </span>
 </p>
 <p>
...
one
 ...
 <h3 id="the-glob-operator">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#the-glob-operator")
}}>
   The Glob Operator
  </a>
 </h3>
...
into the
  ...
  module; we’ll talk about that in the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch11-01-writing-tests.html#how-to-write-tests")
}}>
   “How to Write
Tests”
  </a>
  <!-- ignore -->
  section in Chapter 11. The glob operator
is also sometimes used as part of the prelude pattern: see
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/prelude/index.html#other-preludes")
}}>
   the standard
