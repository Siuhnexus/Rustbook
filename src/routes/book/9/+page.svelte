<main>
 <h1 id="managing-growing-projects-with-packages-crates-and-modules">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#managing-growing-projects-with-packages-crates-and-modules")
}}>
...
in the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch14-03-cargo-workspaces.html")
}}>
   “Cargo Workspaces”
  </a>
  <!-- ignore -->
