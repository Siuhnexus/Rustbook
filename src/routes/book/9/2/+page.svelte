<main>
 <h2 id="paths-for-referring-to-an-item-in-the-module-tree">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#paths-for-referring-to-an-item-in-the-module-tree")
}}>
...
modules by using the
 ...
 <h3 id="exposing-paths-with-the-pub-keyword">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#exposing-paths-with-the-pub-keyword")
}}>
   Exposing Paths with the
   <code>
    pub
...
interested in this topic, see
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://rust-lang.github.io/api-guidelines/")
}}>
 ...
 <section aria-role="note" class="note">
  <h4 id="best-practices-for-packages-with-a-binary-and-a-library">
   <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#best-practices-for-packages-with-a-binary-and-a-library")
}}>
...
client!
  ...
  <p>
   ...
   <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch12-00-an-io-project.html")
}}>
    Chapter 12
   </a>
   <!-- ignore -->
...
and a library crate.
 ...
 <h3 id="starting-relative-paths-with-super">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#starting-relative-paths-with-super")
}}>
...
code gets moved to a different module.
 ...
 <h3 id="making-structs-and-enums-public">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#making-structs-and-enums-public")
}}>
