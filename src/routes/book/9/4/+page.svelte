<main>
 <h2 id="separating-modules-into-different-files">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#separating-modules-into-different-files")
}}>
...
directories and files more closely match the module tree.
 ...
 <section aria-role="note" class="note">
  <h3 id="alternate-file-paths">
   <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#alternate-file-paths")
}}>
