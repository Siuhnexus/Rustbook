<main>
 <h2 id="defining-modules-to-control-scope-and-privacy">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#defining-modules-to-control-scope-and-privacy")
}}>
...
the
 ...
 <h3 id="modules-cheat-sheet">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#modules-cheat-sheet")
}}>
   Modules Cheat Sheet
  </a>
 </h3>
...
pub struct Asparagus &#123;&#125;</code></pre>
 ...
 <h3 id="grouping-related-code-in-modules">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#grouping-related-code-in-modules")
}}>
