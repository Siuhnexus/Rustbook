<main>
 <h2 id="comparing-performance-loops-vs-iterators">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#comparing-performance-loops-vs-iterators")
}}>
...
implementation is faster: the version of the
  <code>
   search
  </code>
...
Sherlock Holmes
  ...
  by Sir Arthur Conan Doyle into a
  <code>
   String
  </code>
  and looking for the
word
  ...
  in the contents. Here are the results of the benchmark on the
version of
  <code>
   search
  </code>
...
of Rust’s
  ...
  , by which we mean using the abstraction
...
values with the previous 12 values in
  <code>
   buffer
  </code>
