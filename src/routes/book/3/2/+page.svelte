<main>
 <h2 id="hello-cargo">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#hello-cargo")
}}>
   Hello, Cargo!
  </a>
 </h2>
...
used the official installers discussed in the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch01-01-installation.html#installation")
}}>
   “Installation”
  </a>
  <!-- ignore -->
...
determine how to install Cargo separately.
 ...
 <h3 id="creating-a-project-with-cargo">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#creating-a-project-with-cargo")
}}>
...
original “Hello, world!” project. Navigate back to your
  <em>
   projects
  </em>
  directory
...
$ cd hello_cargo
 ...
 <p>
  ...
  .
We’ve named our project
  <em>
   hello_cargo
  </em>
  , and Cargo creates its files in a
directory of the same name.
 ...
 <p>
  ...
  directory and list the files. You’ll see that Cargo
has generated two files and one directory for us: a
  <em>
   Cargo.toml
  </em>
  file and a
 ...
 <p>
  ...
  file.
Git files won’t be generated if you run
  <code>
   cargo new
  </code>
  within an existing Git
repository; you can override this behavior by using
  <code>
   cargo new --vcs=git
  </code>
  .
...
the
 ...
 <p>
  ...
  in your text editor of choice. It should look similar to the
code in Listing 1-2.
 </p>
...
[dependencies]
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://toml.io")
}}>
   <em>
    TOML
   </em>
...
about the
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("appendix-05-editions.html")
}}>
   Appendix E
  </a>
  <!-- ignore -->
...
of your project’s dependencies. In Rust, packages of code are referred to as
  ...
  . We won’t need any other crates for this project, but we will in the
...
project Cargo generated are that Cargo placed the code in the
  <em>
   src
  </em>
  directory
...
project code into the
  <em>
   src
  </em>
  directory and create an appropriate
  <em>
   Cargo.toml
  </em>
  file. One easy way to get that
  <em>
   Cargo.toml
  </em>
  file is to run
...
will create it for you automatically.
 ...
 <h3 id="building-and-running-a-cargo-project">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#building-and-running-a-cargo-project")
}}>
...
program with Cargo! From your
  <em>
   hello_cargo
  </em>
  directory, build your project by
entering the following command:
 ...
 <p>
  ...
  on Windows) rather than in your current
...
Hello, world!
 ...
 <p>
  ...
  should print to the terminal. Running
  <code>
   cargo build
  </code>
...
level:
  ...
  . This file keeps track of the exact versions of
dependencies in your project. This project doesn’t have dependencies, so the
file is a bit sparse. You won’t ever need to change this file manually; Cargo
manages its contents for you.
 </p>
 <p>
  We just built a project with
  <code>
   cargo build
  </code>
  and ran it with
...
Hello, world!
 ...
 <p>
  ...
  is more convenient than having to remember to run
  <code>
   cargo build
  </code>
  and then use the whole path to the binary, so most developers use
  <code>
   cargo run
  </code>
  .
...
continually checking your work while writing the code, using
  <code>
   cargo check
  </code>
  will
speed up the process of letting you know if your project is still compiling! As
such, many Rustaceans run
  <code>
   cargo check
  </code>
  periodically as they write their
program to make sure it compiles. Then they run
  <code>
   cargo build
  </code>
  when they’re
...
longer provide specific instructions for Linux and macOS versus Windows.
 ...
 <h3 id="building-for-release">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#building-for-release")
}}>
...
code’s running time, be sure to run
  <code>
   cargo build --release
  </code>
  and benchmark with
the executable in
 ...
 <h3 id="cargo-as-convention">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#cargo-as-convention")
}}>
   Cargo as Convention
  </a>
 </h3>
