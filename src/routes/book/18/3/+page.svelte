<main>
 <h2 id="extensible-concurrency-with-the-sync-and-send-traits">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#extensible-concurrency-with-the-sync-and-send-traits")
}}>
 ...
 <p>
  Interestingly, the Rust language has
  <em>
   very
  </em>
  few concurrency features. Almost
...
write your own concurrency features or use those written by others.
 ...
 <h3 id="allowing-transference-of-ownership-between-threads-with-send">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#allowing-transference-of-ownership-between-threads-with-send")
}}>
...
compiled.
 ...
 <p>
  ...
  types is automatically marked as
  <code>
   Send
  </code>
  as
...
we’ll discuss in Chapter 19.
 ...
 <h3 id="allowing-access-from-multiple-threads-with-sync">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#allowing-access-from-multiple-threads-with-sync")
}}>
 ...
 <p>
  ...
  to be referenced from multiple threads. In other words, any type
  <code>
   T
  </code>
  is
...
can be sent safely to another thread. Similar to
  ...
  , and types composed entirely of types that are
  <code>
   Sync
  </code>
  are also
...
threads as you saw in the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch16-03-shared-state.html#sharing-a-mutext-between-multiple-threads")
}}>
   “Sharing a
   <code>
    Mutex&lt;T&gt;
...
Threads”
 ...
 <h3 id="implementing-send-and-sync-manually-is-unsafe">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#implementing-send-and-sync-manually-is-unsafe")
}}>
   Implementing
   <code>
    Send
...
Rustonomicon”
  ...
  has more information about these guarantees and how to
uphold them.
 </p>
 <h2 id="summary">
  <a class="header" href="#" onclick={() => {
