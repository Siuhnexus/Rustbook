<main>
 <h1 id="programming-a-guessing-game">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#programming-a-guessing-game")
}}>
...
them in a real program. You’ll learn about
  <code>
   let
  </code>
  ,
...
correct, the game will print a congratulatory message and exit.
 ...
 <h2 id="setting-up-a-new-project">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#setting-up-a-new-project")
}}>
   Setting Up a New Project
  </a>
 </h2>
 <p>
  To set up a new project, go to the
  <em>
   projects
  </em>
...
the next one.
 ...
 <p>
  ...
  file. You’ll be writing all the code in this file.
 </p>
 <h2 id="processing-a-guess">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#processing-a-guess")
}}>
   Processing a Guess
  </a>
 </h2>
...
obtain user input and then print the result as output, we need to bring the
  ...
  input/output library into scope. The
  <code>
   io
  </code>
...
brings into the scope of every program. This set is called the
  <em>
   prelude
  </em>
  , and
you can see everything in it
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/prelude/index.html")
}}>
...
are no parameters; and the curly bracket,
 ...
 <p>
  As you also learned in Chapter 1,
  <code>
   println!
  </code>
...
from the user.
 ...
 <h3 id="storing-values-with-variables">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#storing-values-with-variables")
}}>
 ...
 <p>
  ...
  to store the user input, like this:
 </p>
 <pre><code class="language-rust ignore"><span class="boring">use std::io;
</span><span class="boring">
</span><span class="boring">fn main() &#123;
...
line. We use the
 ...
 <p>
  This line creates a new variable named
  <code>
   apples
  </code>
...
the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch03-01-variables-and-mutability.html#variables-and-mutability")
}}>
   “Variables and Mutability”
  </a>
  <!-- ignore -->
  section in Chapter 3. To make a variable mutable, we add
  <code>
   mut
  </code>
  before the
...
detail in
   <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch03-04-comments.html")
}}>
    Chapter 3
   </a>
   <!-- ignore -->
 ...
 <p>
  ...
  will
introduce a mutable variable named
  <code>
   guess
  </code>
  . The equal sign (
...
the value that
  ...
  , a function that returns a new instance of a
  <code>
   String
  </code>
  .
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/string/struct.String.html")
}}>
   <code>
    String
   </code>
...
implemented on a type, in this case
  <code>
   String
  </code>
  . This
  ...
  function creates a
new, empty string. You’ll find a
  <code>
   new
  </code>
...
variable that is currently bound to a new, empty instance of a
  <code>
   String
  </code>
  . Whew!
 </p>
 <h3 id="receiving-user-input">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#receiving-user-input")
}}>
...
the program, we could still use the function by writing this function call as
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/io/struct.Stdin.html")
}}>
   <code>
    std::io::Stdin
   </code>
...
handle to the standard input for your terminal.
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/io/struct.Stdin.html#method.read_line")
}}>
   <code>
    read_line
   </code>
...
We’re also passing
  ...
  to tell it what
string to store the user input in. The full job of
  <code>
   read_line
  </code>
  is to take
...
thoroughly.)
 ...
 <p>
  <a id="handling-potential-failure-with-the-result-type">
  </a>
 </p>
 <h3 id="handling-potential-failure-with-result">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#handling-potential-failure-with-result")
}}>
...
lines when you call a method with the
  <code>
   .method_name()
  </code>
  syntax. Now let’s
...
we pass to it, but it also returns a
  <code>
   Result
  </code>
  value.
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/result/enum.Result.html")
}}>
   <code>
    Result
   </code>
...
ignore -->
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch06-00-enums.html")
}}>
   <em>
    enumeration
   </em>
...
operation was successful, and inside
  <code>
   Ok
  </code>
...
The
  ...
  variant means the operation failed, and
  <code>
   Err
  </code>
...
them. An instance of
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/result/enum.Result.html#method.expect")
}}>
   <code>
    expect
   </code>
...
warning: `guessing_game` (bin "guessing_game") generated 1 warning
 ...
 <p>
  Rust warns that you haven’t used the
  <code>
   Result
  </code>
  value returned from
...
can use
  ...
  . You’ll learn about recovering from errors in
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch09-02-recoverable-errors-with-result.html")
}}>
   Chapter
9
  </a>
 ...
 <h3 id="printing-values-with-println-placeholders">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#printing-values-with-println-placeholders")
}}>
...
of an expression in one call to
  <code>
   println!
  </code>
...
<span class="boring">&#125;</span></code></pre></pre>
 ...
 <h3 id="testing-the-first-part">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#testing-the-first-part")
}}>
...
keyboard and then printing it.
 ...
 <h2 id="generating-a-secret-number">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#generating-a-secret-number")
}}>
...
library. However, the Rust team does provide a
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://crates.io/crates/rand")
}}>
   <code>
    rand
   </code>
...
said functionality.
 ...
 <h3 id="using-a-crate-to-get-more-functionality">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#using-a-crate-to-get-more-functionality")
}}>
...
we’ve been building is a
  <em>
   binary crate
  </em>
  , which is an executable. The
  <code>
   rand
  </code>
  crate is a
  ...
  , which contains code that is intended to be used in
...
following line to the bottom, beneath the
  <code>
   [dependencies]
  </code>
  section header that
Cargo created for you. Be sure to specify
  <code>
   rand
  </code>
...
rand = "0.8.5"
 ...
 <p>
  ...
  file, everything that follows a header is part of that
section that continues until another section starts. In
  <code>
   [dependencies]
  </code>
  you
tell Cargo which external crates your project depends on and which versions of
those crates you require. In this case, we specify the
  <code>
   rand
  </code>
  crate with the
semantic version specifier
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("http://semver.org")
}}>
   Semantic
Versioning
  </a>
...
standard for writing version numbers. The specifier
  <code>
   0.8.5
  </code>
  is actually
...
cargo build -->
 <figure class="listing">
  ...
  <figcaption>
   Listing 2-2: The output from running
   <code>
    cargo build
   </code>
...
everything that dependency needs from the
  <em>
   registry
  </em>
  , which is a copy of data
from
  <a href="#" onclick={() => {
    // @ts-ignore
...
won’t get any output aside from the
  <code>
   Finished
  </code>
...
about them in your
  ...
  file. Cargo also knows that you haven’t changed
...
do, it simply exits.
 ...
 <p>
  ...
  file, make a trivial change, and then save it and
...
cargo build -->
 ...
 <p>
  ...
  file. Your dependencies haven’t changed, so Cargo knows it can
reuse what it has already downloaded and compiled for those.
 </p>
 <h4 id="ensuring-reproducible-builds-with-the-cargolock-file">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#ensuring-reproducible-builds-with-the-cargolock-file")
}}>
...
next week version 0.8.6 of the
  <code>
   rand
  </code>
  crate comes out, and that version
contains an important bug fix, but it also contains a regression that will
break your code. To handle this, Rust creates the
  <em>
   Cargo.lock
  </em>
  file the first
...
of the dependencies that fit the criteria and then writes them to the
  ...
  file. When you build your project in the future, Cargo will see
that the
  <em>
   Cargo.lock
  </em>
  file exists and will use the versions specified there
rather than doing all the work of figuring out versions again. This lets you
have a reproducible build automatically. In other words, your project will
remain at 0.8.5 until you explicitly upgrade, thanks to the
  <em>
   Cargo.lock
  </em>
  file.
Because the
  ...
  file is important for reproducible builds, it’s often
checked into source control with the rest of the code in your project.
 </p>
 <h4 id="updating-a-crate-to-get-a-new-version">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#updating-a-crate-to-get-a-new-version")
}}>
 ...
 <p>
  ...
  want to update a crate, Cargo provides the command
  <code>
   update
  </code>
  ,
which will ignore the
  ...
  file and figure out all the latest versions
that fit your specifications in
  <em>
   Cargo.toml
  </em>
  . Cargo will then write those
versions to the
  <em>
   Cargo.lock
  </em>
  file. In this case, Cargo will only look for
versions greater than 0.8.5 and less than 0.9.0. If the
  <code>
   rand
  </code>
  crate has
...
in your
  ...
  file noting that the version of the
  <code>
   rand
  </code>
  crate you are
now using is 0.8.6. To use
  <code>
   rand
  </code>
  version 0.9.0 or any version in the 0.9.
  <em>
   x
  </em>
  series, you’d have to update the
  <em>
   Cargo.toml
  </em>
...
you have specified.
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://doc.rust-lang.org/cargo/")
}}>
   Cargo
  </a>
  <!-- ignore -->
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("https://doc.rust-lang.org/cargo/reference/publishing.html")
}}>
   its
ecosystem
  </a>
...
from a number of packages.
 ...
 <h3 id="generating-a-random-number">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#generating-a-random-number")
}}>
...
execution and is seeded by the operating system. Then we call the
  ...
  method on the random number generator. This method is defined by the
  <code>
   Rng
  </code>
  trait that we brought into scope with the
  <code>
   use rand::Rng;
  </code>
  statement. The
...
1 and 100. Great job!
 ...
 <h2 id="comparing-the-guess-to-the-secret-number">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#comparing-the-guess-to-the-secret-number")
}}>
...
&#125;</code></pre>
 ...
 <p>
  ...
  into scope from the standard library. The
  <code>
   Ordering
  </code>
  type
is another enum and has the variants
  <code>
   Less
  </code>
  ,
...
comparing
  ...
  enum we brought into scope with the
  <code>
   use
  </code>
  statement. We use a
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch06-02-match.html")
}}>
   <code>
    match
   </code>
...
match against, and the code that should be run if the value given to
  ...
  fits that arm’s pattern. Rust takes the value given to
  <code>
   match
  </code>
  and looks
through each arm’s pattern in turn. Patterns and the
  <code>
   match
  </code>
  construct are
...
38.
 ...
 <p>
  When the code compares 50 to 38, the
  <code>
   cmp
  </code>
  method will return
  ...
  because 50 is greater than 38. The
  <code>
   match
  </code>
  expression gets
...
that arm and moves to the next arm. The next arm’s pattern is
  ...
  ! The associated
code in that arm will execute and print
  <code>
   Too big!
  </code>
  to the screen. The
...
a
  ...
  and didn’t make us write the type. The
  <code>
   secret_number
  </code>
  , on the other
...
for the error is that Rust cannot compare a string and a number type.
 ...
 <p>
  Ultimately, we want to convert the
  <code>
   String
  </code>
...
previous value of
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch03-01-variables-and-mutability.html#shadowing")
}}>
   Chapter 3
  </a>
  <!-- ignore -->
...
often used when you want to convert a value from one type to another type.
 ...
 <p>
  ...
  in the expression refers to the original
  <code>
   guess
  </code>
  variable that contained the
input as a string. The
  <code>
   trim
  </code>
  method on a
...
in just
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("../std/primitive.str.html#method.parse")
}}>
   <code>
    parse
   </code>
...
few built-in number types; the
  <code>
   u32
  </code>
  seen here is an unsigned, 32-bit integer.
It’s a good default choice for a small positive number. You’ll learn about
other number types in
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch03-02-data-types.html#integer-types")
}}>
   Chapter 3
  </a>
  <!-- ignore -->
...
Let’s change that by adding a loop!
 ...
 <h2 id="allowing-multiple-guesses-with-looping">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#allowing-multiple-guesses-with-looping")
}}>
...
which actually introduces a new problem. It doesn’t seem like the user can quit!
 ...
 <p>
  ...
  . But there’s another way to escape this insatiable
monster, as mentioned in the
  <code>
   parse
  </code>
  discussion in
...
to also stop when the correct number is guessed.
 ...
 <h3 id="quitting-after-a-correct-guess">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#quitting-after-a-correct-guess")
}}>
...
exiting the program, because the loop is the last part of
 ...
 <h3 id="handling-invalid-input">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#handling-invalid-input")
}}>
...
on an error to handling the error. Remember that
  <code>
   parse
  </code>
  returns a
  ...
  is an enum that has the variants
  <code>
   Ok
  </code>
  and
...
a
  ...
  expression here, as we did with the
  <code>
   Ordering
  </code>
  result of the
...
return an
  ...
  value that contains the resultant number. That
  <code>
   Ok
  </code>
  value will
match the first arm’s pattern, and the
  <code>
   match
  </code>
  ...
  produced and put inside the
  <code>
   Ok
  </code>
  value. That number
will end up right where we want it in the new
  <code>
   guess
  </code>
 ...
 <p>
  ...
  able to turn the string into a number, it will return an
  <code>
   Err
  </code>
  value that contains more information about the error. The
  <code>
   Err
  </code>
  value
...
match the
  ...
  pattern in the second arm. The underscore,
  <code>
   _
  </code>
  , is a
catchall value; in this example, we’re saying we want to match all
  <code>
   Err
  </code>
  values, no matter what information they have inside them. So the program will
execute the second arm’s code,
  <code>
   continue
  </code>
...
program ignores all errors that
  <code>
   parse
  </code>
  might encounter!
...
testing, but it ruins the game. Let’s delete the
  <code>
   println!
  </code>
  that outputs the
