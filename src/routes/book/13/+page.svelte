<main>
 <h1 id="writing-automated-tests">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#writing-automated-tests")
}}>
...
to this function. But Rust
  <em>
   can’t
  </em>
  check that this function will do precisely
...
parameter plus 10 or the parameter minus 50! That’s where tests come in.
 ...
 <p>
  ...
  function, the returned value is
  <code>
   5
  </code>
