<main>
 <h2 id="traits-defining-shared-behavior">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#traits-defining-shared-behavior")
}}>
 ...
 <p>
  ...
  defines the functionality a particular type has and can share with
other types. We can use traits to define shared behavior in an abstract way. We
can use
  <em>
   trait bounds
  </em>
  to specify that a generic type can be any type that has
certain behavior.
 </p>
...
languages, although with some differences.
 ...
 <h3 id="defining-a-trait">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#defining-a-trait")
}}>
   Defining a Trait
  </a>
 </h3>
...
to another tweet.
 ...
 <p>
  ...
  that can
display summaries of data that might be stored in a
  <code>
   NewsArticle
  </code>
  or
...
behavior provided by a
 ...
 <p>
  Here, we declare a trait using the
  <code>
   trait
  </code>
...
which is
  ...
  in this case. We also declare the trait as
  <code>
   pub
  </code>
  so that
...
that any type that has the
  <code>
   Summary
  </code>
  trait will have the method
  <code>
   summarize
  </code>
...
one per line, and each line ends in a semicolon.
 ...
 <h3 id="implementing-a-trait-on-a-type">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#implementing-a-trait-on-a-type")
}}>
...
implement the trait for. Within the
  <code>
   impl
  </code>
...
behavior that we want the methods of the trait to have for the particular type.
 ...
 <p>
  Now that the library has implemented the
  <code>
   Summary
  </code>
  trait on
...
&#125;</code></pre>
 ...
 <p>
  Other crates that depend on the
  <code>
   aggregator
  </code>
  crate can also bring the
  <code>
   Summary
  </code>
  trait into scope to implement
  <code>
   Summary
  </code>
...
library traits like
  ...
  crate functionality because the type
  <code>
   Tweet
  </code>
  is local to our
...
to use.
 ...
 <h3 id="default-implementations">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#default-implementations")
}}>
...
a small part of it. For example, we could define the
  <code>
   Summary
  </code>
  trait to have a
...
&#125;</code></pre>
 <p>
  ...
  struct, and the default implementation of
  <code>
   summarize
  </code>
  will call the
...
overriding implementation of that same method.
 ...
 <h3 id="traits-as-parameters">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#traits-as-parameters")
}}>
...
specified trait. In the body of
  <code>
   notify
  </code>
  , we can call any methods on
  <code>
   item
  </code>
  that come from the
  ...
  . Code that calls the
function with any other type, such as a
  <code>
   String
  </code>
  or an
  ...
  , won’t compile
because those types don’t implement
  <code>
   Summary
  </code>
  .
 ...
 <p>
  <a id="fixing-the-largest-function-with-trait-bounds">
  </a>
 </p>
 <h4 id="trait-bound-syntax">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#trait-bound-syntax")
}}>
   Trait Bound Syntax
  </a>
 </h4>
...
sugar for a longer form known as a
  <em>
   trait bound
  </em>
  ; it looks like this:
...
so with the
 ...
 <p>
  ...
  is appropriate if we want this function to allow
  <code>
   item1
  </code>
  and
  ...
  to have different types (as long as both types implement
  <code>
   Summary
  </code>
  ). If
...
passed as an argument for
 ...
 <h4 id="specifying-multiple-trait-bounds-with-the--syntax">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#specifying-multiple-trait-bounds-with-the--syntax")
}}>
...
so using the
 ...
 <h4 id="clearer-trait-bounds-with-where-clauses">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#clearer-trait-bounds-with-where-clauses")
}}>
...
syntax for specifying trait bounds inside a
  <code>
   where
  </code>
...
bounds.
 ...
 <h3 id="returning-types-that-implement-traits">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#returning-types-that-implement-traits")
}}>
...
&#125;</code></pre>
 <p>
  ...
  function returns some type that implements the
  <code>
   Summary
  </code>
...
types that are very long to specify. The
  <code>
   impl Trait
  </code>
...
example, this code that returns either a
  <code>
   NewsArticle
  </code>
  or a
...
ignore -->
 ...
 <h3 id="using-trait-bounds-to-conditionally-implement-methods">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#using-trait-bounds-to-conditionally-implement-methods")
}}>
   Using Trait Bounds to Conditionally Implement Methods
  </a>
 </h3>
 <p>
  By using a trait bound with an
  <code>
   impl
  </code>
  block that uses generic type parameters,
we can implement methods conditionally for types that implement the specified
traits. For example, the type
  <code>
   Pair&lt;T&gt;
  </code>
  ...
  function to return a new instance of
  <code>
   Pair&lt;T&gt;
  </code>
  (recall from the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch05-03-method-syntax.html#defining-methods")
}}>
   “Defining Methods”
  </a>
  <!-- ignore -->
  ...
  is a type alias for the type of the
  <code>
   impl
  </code>
...
bounds are called
  ...
  and are used extensively in the
