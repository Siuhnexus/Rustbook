<main>
 <h2 id="implementing-an-object-oriented-design-pattern">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#implementing-an-object-oriented-design-pattern")
}}>
...
will be managed internally within the
  <code>
   Post
  </code>
  type. The states change in
response to the methods called by our library’s users on the
  <code>
   Post
  </code>
  instance,
...
make a mistake with the states, like publishing a post before it’s reviewed.
 ...
 <h3 id="defining-post-and-creating-a-new-instance-in-the-draft-state">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#defining-post-and-creating-a-new-instance-in-the-draft-state")
}}>
   Defining
   <code>
    Post
...
holds a
  ...
  struct.
This ensures whenever we create a new instance of
  <code>
   Post
  </code>
...
create a
 ...
 <h3 id="storing-the-text-of-the-post-content">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#storing-the-text-of-the-post-content")
}}>
...
<span class="boring">
 ...
 <p>
  <span class="caption">
   Listing 17-13: Implementing the
   <code>
    add_text
   </code>
   method to add
...
support.
 ...
 <h3 id="ensuring-the-content-of-a-draft-post-is-empty">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#ensuring-the-content-of-a-draft-post-is-empty")
}}>
...
works as intended.
 ...
 <h3 id="requesting-a-review-of-the-post-changes-its-state">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#requesting-a-review-of-the-post-changes-its-state")
}}>
...
Listing 17-11 now works up to line 10!
 ...
 <h3 id="adding-approve-to-change-the-behavior-of-content">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#adding-approve-to-change-the-behavior-of-content")
}}>
   Adding
   <code>
    approve
...
the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch09-03-to-panic-or-not-to-panic.html#cases-in-which-you-have-more-information-than-the-compiler")
}}>
...
rules lives in the state objects rather than being scattered throughout
 ...
 <section aria-role="note" class="note">
  <h4 id="why-not-an-enum">
   <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#why-not-an-enum")
}}>
    Why Not An Enum?
   </a>
  </h4>
...
get more repetitive than this trait object solution.
 ...
 <h3 id="trade-offs-of-the-state-pattern">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#trade-offs-of-the-state-pattern")
}}>
...
the concrete
  ...
  will be exactly. We want to be able to use
  <code>
   State
  </code>
  as a
...
the same method on the value in the
  <code>
   state
  </code>
  field of
...
repetition (see the
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch19-06-macros.html#macros")
}}>
   “Macros”
  </a>
  <!-- ignore -->
...
invalid states and transitions into compile time errors.
 ...
 <h4 id="encoding-states-and-behavior-as-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#encoding-states-and-behavior-as-types")
}}>
...
Listing 17-19 shows the definition of a
  <code>
   Post
  </code>
  struct and a
...
these constraints will result in a compiler error.
 ...
 <h4 id="implementing-transitions-as-transformations-into-different-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#implementing-transitions-as-transformations-into-different-types")
}}>
