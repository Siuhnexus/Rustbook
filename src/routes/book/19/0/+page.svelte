<main>
 <h2 id="characteristics-of-object-oriented-languages">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#characteristics-of-object-oriented-languages")
}}>
...
Rust supports it.
 ...
 <h3 id="objects-contain-data-and-behavior">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#objects-contain-data-and-behavior")
}}>
...
Professional, 1994), colloquially referred to as
  <em>
   The Gang of Four
  </em>
  book, is a
...
functionality, according to the Gang of Four’s definition of objects.
 ...
 <h3 id="encapsulation-that-hides-implementation-details">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#encapsulation-that-hides-implementation-details")
}}>
...
code would likely have to change if it were modifying
  <code>
   list
  </code>
  directly.
...
not for different parts of code enables encapsulation of implementation details.
 ...
 <h3 id="inheritance-as-a-type-system-and-as-code-sharing">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#inheritance-as-a-type-system-and-as-code-sharing")
}}>
...
each other at runtime if they share certain characteristics.
 ...
 <section aria-role="note" class="note">
  <h3 id="polymorphism">
   <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#polymorphism")
}}>
    Polymorphism
   </a>
  </h3>
