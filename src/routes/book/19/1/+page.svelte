<main>
 <h2 id="using-trait-objects-that-allow-for-values-of-different-types">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#using-trait-objects-that-allow-for-values-of-different-types")
}}>
...
allow users to extend it with new types.
 ...
 <h3 id="defining-a-trait-for-common-behavior">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#defining-a-trait-for-common-behavior")
}}>
...
trait objects must use a pointer in Chapter 19 in the section
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch19-04-advanced-types.html#dynamically-sized-types-and-the-sized-trait")
}}>
   “Dynamically
Sized Types and the
   <code>
...
&#125;</code></pre>
 <p>
  <span class="caption">
   Listing 17-3: Definition of the
   <code>
    Draw
   </code>
   trait
...
&#125;</code></pre>
 <p>
  <span class="caption">
   Listing 17-4: Definition of the
   <code>
    Screen
   </code>
   struct with a
...
runtime performance implications.
 ...
 <h3 id="implementing-the-trait">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#implementing-the-trait")
}}>
...
didn’t mean to pass and so should pass a different type or we should implement
 ...
 <h3 id="trait-objects-perform-dynamic-dispatch">
  <a class="header" href="#" onclick={() => {
    // @ts-ignore
    window.externallink("#trait-objects-perform-dynamic-dispatch")
}}>
 ...
 <p>
  ...
  <a href="#" onclick={() => {
    // @ts-ignore
    window.externallink("ch10-01-syntax.html#performance-of-code-using-generics")
}}>
...
monomorphization is doing
  <em>
   static dispatch
  </em>
  , which is when the compiler knows
what method you’re calling at compile time. This is opposed to
  <em>
   dynamic
dispatch
  </em>
  , which is when the compiler can’t tell at compile time which method
